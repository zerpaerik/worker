...
class NewCresheet2 extends StatefulWidget {
  ...
  @override
  _NewCresheet2State createState() =>
      _NewCresheet2State(user, workday, contract, location);
}

class _NewCresheet2State extends State<NewCresheet2> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  Map<String, dynamic>? location;

  _NewCresheet2State(this.user, this.workday, this.contract, this.location);
