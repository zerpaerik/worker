...
import 'package:worker/widgets/workday-report/editm/standby.dart';

import '../../../model/user.dart';
import 'package:intl/intl.dart' show DateFormat;

class EditWorkdayM3 extends StatefulWidget {
  ...
  @override
  _EditWorkdayM3State createState() => _EditWorkdayM3State(
      user, workday, contract, wr, report, worker, workerDescription);
}

class _EditWorkdayM3State extends State<EditWorkdayM3> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  WorkdayRegister? wr;
  ...
  List? worker = [];
  List? workerDescription = [];
  _EditWorkdayM3State(this.user, this.workday, this.contract, this.wr,
