...
class TodayAbsents extends StatefulWidget {
  static const routeName = '/my-clockin';
  final int? workday;
  Map<String, dynamic>? contract;

  TodayAbsents({this.workday, this.contract});

  @override
  _TodayAbsentsState createState() => _TodayAbsentsState(workday, contract);
}

class _TodayAbsentsState extends State<TodayAbsents> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  Workday? work;
  ...
  _TodayAbsentsState(this.workday, this.contract);
  // ignore: unused_field
