...
class NewCresheet3 extends StatefulWidget {
  ...
  @override
  _NewCresheet3State createState() =>
      _NewCresheet3State(user, workday, contract, location);
}

class _NewCresheet3State extends State<NewCresheet3> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  Map<String, dynamic>? location;

  _NewCresheet3State(this.user, this.workday, this.contract, this.location);
                        ...
                        onPressed: () {
                          setState(() {
                            dataCrew = {
                              ...
                              "standby_duration": durationLunch,
                            };
                          });
                          print(durationLunch);
