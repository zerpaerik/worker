...
import 'package:worker/widgets/projects/crewsheets/step_01.dart';
...
class NewCresheet0 extends StatefulWidget {
  ...
  @override
  _NewCresheet0State createState() =>
      _NewCresheet0State(user, workday, contract, location, crew);
}

class _NewCresheet0State extends State<NewCresheet0> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  Map<String, dynamic>? location;
  ...
  void initState() {
    ...
    setState(() {
      ...
      _time = DateFormat('hh:mm aa')
          .format(DateTime.parse((widget.crew!['clock_in_start'].toString())));
      hourClock = DateTime.parse((widget.crew!['clock_in_start'].toString()));
      _time1 = DateFormat('hh:mm aa').format(
          DateTime.parse((widget.crew!['default_exit_time'].toString())));
      hourClock1 =
          DateTime.parse((widget.crew!['default_exit_time'].toString()));
    });
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child:
                                Text(l10n.wr_4, style: TextStyle(fontSize: 16)),
                          )
                        ],
                      )),
                ),
                      ...
                      onPressed: hourClock != null &&
                          ...
                          ? () {
                              if (start_time!.isAfter(end_time!)) {
                                ...
                                setState(() {
                                  dataCrew = {
                                    "inicio_s": DateTime.parse(
                                        start_time.toString().substring(0, 11) +
                                            hourClock
                                                .toString()
                                                .substring(10, 23)
                                                .replaceAll(" ", "")),
                                    "fin_s": DateTime.parse(
