...
class UpdateOutFin extends StatefulWidget {
  final User? user;
  final int? workday;
  ...
  @override
  _UpdateOutFinState createState() =>
      _UpdateOutFinState(user!, workday!, contract!, work!, wk!, dif!);
}

class _UpdateOutFinState extends State<UpdateOutFin> {
  Map<String, dynamic> contract;
  User user;
  int workday;
  Workday work;
