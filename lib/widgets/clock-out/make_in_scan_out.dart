...
class MakeInOutScan extends StatefulWidget {
  final User? user;
  final int? workday;
  ...
  @override
  _MakeInOutScanState createState() =>
      _MakeInOutScanState(user!, workday!, contract!, work!, wk!, init!);
}

class _MakeInOutScanState extends State<MakeInOutScan> {
  Map<String, dynamic> contract;
  User user;
  int workday;
  Workday work;
