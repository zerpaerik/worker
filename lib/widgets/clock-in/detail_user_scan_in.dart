...
class DetailUserClockIn extends StatefulWidget {
  final User? user;
  final int? workday;
  final String? lat;
  final String? long;
  ...
  @override
  _DetailUserClockInState createState() => _DetailUserClockInState(
      user!, workday!, lat!, long!, contract!, wk!, work!, us!, datas!);
}

class _DetailUserClockInState extends State<DetailUserClockIn> {
  ...
  _DetailUserClockInState(this.user, this.workday, this.lat, this.long,
