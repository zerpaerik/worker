...
class NewWorkdayReport4 extends StatefulWidget {
  ...
  @override
  _NewWorkdayReport4State createState() =>
      _NewWorkdayReport4State(user, workday, report, contract);
}

class _NewWorkdayReport4State extends State<NewWorkdayReport4> {
  User? user;
  int? workday;
  int? report;
  Map<String, dynamic>? contract;

  _NewWorkdayReport4State(this.user, this.workday, this.report, this.contract);
  ...
  Future<void> _submit() async {
    ...
    try {
      Provider.of<WorkDay>(context, listen: false)
          .editWorkdayReport4(widget.workday, hourClock, hourClock1,
        ...
        if (response['status'] == '200') {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => NewWorkdayReport5(
                      user: user,
