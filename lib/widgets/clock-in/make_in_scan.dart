...
import 'init.dart';
import 'list.dart';
import 'update_init.dart';

class MakeInScan extends StatefulWidget {
  final User? user;
  final int? workday;
  ...
  @override
  _MakeInScanState createState() =>
      _MakeInScanState(user!, workday!, contract!, work!, wk!);
}

class _MakeInScanState extends State<MakeInScan> {
  Map<String, dynamic> contract;
  User user;
  int workday;
  Workday work;
  ...
  _MakeInScanState(this.user, this.workday, this.contract, this.work, this.wk);
