...
class NewWorkdayReport1 extends StatefulWidget {
  ...
  @override
  _NewWorkdayReport1State createState() =>
      _NewWorkdayReport1State(user, workday, report, contract);
}

class _NewWorkdayReport1State extends State<NewWorkdayReport1> {
  User? user;
  int? workday;
  int? report;
  Map<String, dynamic>? contract;

  _NewWorkdayReport1State(this.user, this.workday, this.report, this.contract);
  ...
  Future<void> _delete() async {
    ...
    var res = await http.delete(
        Uri.parse(
            '${ApiWebServer.server_name}/api/v-1/workday/workday-report/$report/delete'),
      ...
      Provider.of<WorkDay>(context, listen: false)
        ...
        if (response['status'] == '200') {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => NewWorkdayReport2(
                      user: user,
