...
class EditWorkdayM4 extends StatefulWidget {
  ...
  @override
  _EditWorkdayM4State createState() => _EditWorkdayM4State(
      user, workday, contract, wr, report, worker, workerDescription);
}

class _EditWorkdayM4State extends State<EditWorkdayM4> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  WorkdayRegister? wr;
  ...
  List? worker = [];
  List? workerDescription = [];
  _EditWorkdayM4State(this.user, this.workday, this.contract, this.wr,
