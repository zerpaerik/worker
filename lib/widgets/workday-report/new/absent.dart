...
class AbsentWorkday extends StatefulWidget {
  ...
  AbsentWorkday(
      {this.user, required this.workday, required this.report, this.contract});

  @override
  _AbsentWorkdayState createState() =>
      _AbsentWorkdayState(user, workday, report, contract);
}

class _AbsentWorkdayState extends State<AbsentWorkday> {
  User? user;
  int? workday;
  int? report;
  Map<String, dynamic>? contract;

  _AbsentWorkdayState(this.user, this.workday, this.report, this.contract);
  ...
  Future<dynamic> getSWData() async {
    ...
    var res = await http.get(
        Uri.parse(
            '${ApiWebServer.server_name}/api/v-1/workday/$wk/workday-register/absent-list'),
