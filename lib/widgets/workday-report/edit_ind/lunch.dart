...
class EditWorkdayInd2 extends StatefulWidget {
  ...
  @override
  _EditWorkdayInd2State createState() =>
      _EditWorkdayInd2State(user, workday, contract, wr, report);
}

class _EditWorkdayInd2State extends State<EditWorkdayInd2> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  WorkdayRegister? wr;
  Map<String, dynamic>? report;
  _EditWorkdayInd2State(
      ...
      Provider.of<WorkDay>(context, listen: false)
        ...
        if (response == '200') {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => EditWorkdayInd3(
                      user: user,
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        _time != 'S/H'
                            ? _time!
                            : widget.wr!.lunch_start_time != null
                                ? DateFormat('hh:mm:aa')
                                    .format(widget.wr!.lunch_start_time)
                                : 'S/H',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        _time1 != 'S/H'
                            ? _time1!
                            : widget.wr!.lunch_end_time != null
                                ? DateFormat('hh:mm:aa')
                                    .format(widget.wr!.lunch_end_time)
                                : 'S/H',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
