...
class NewWorkdayReportSJ2 extends StatefulWidget {
  ...
  @override
  _NewWorkdayReportSJ2State createState() =>
      _NewWorkdayReportSJ2State(user, workday, report, contract, workers);
}

class _NewWorkdayReportSJ2State extends State<NewWorkdayReportSJ2> {
  User? user;
  int? workday;
  Map<String, dynamic>? report;
  Map<String, dynamic>? contract;
  ...
  Future<void> _submit() async {
    ...
    try {
      Provider.of<WorkDay>(context, listen: false)
          .editWorkdayReportMSJ(durationLunch, hourClock, hourClock1,
              widget.workers, widget.report!['workday'])
          .then((response) {
        setState(() {
          isLoading = false;
        });
