...
class NewWorkdayReport5 extends StatefulWidget {
  ...
  @override
  _NewWorkdayReport5State createState() =>
      _NewWorkdayReport5State(user, workday, report, contract);
}

class _NewWorkdayReport5State extends State<NewWorkdayReport5> {
  User? user;
  int? workday;
  int? report;
  Map<String, dynamic>? contract;

  _NewWorkdayReport5State(this.user, this.workday, this.report, this.contract);
  ...
  Future<void> _submit() async {
    ...
    try {
      Provider.of<WorkDay>(context, listen: false)
          .editWorkdayReport5(widget.workday, comments, widget.report)
          .then((response) {
        setState(() {
          isLoading = false;
        });
