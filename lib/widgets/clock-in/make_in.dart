...
class MakeIn extends StatefulWidget {
  final User? user;
  final int? workday;
  ...
  @override
  _MakeInState createState() =>
      _MakeInState(user!, workday!, contract!, work!, wk!);
}

class _MakeInState extends State<MakeIn> {
  Map<String, dynamic> contract;
  User user;
  int workday;
  Workday work;
  ...
  _MakeInState(this.user, this.workday, this.contract, this.work, this.wk);
