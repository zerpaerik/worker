...
import 'package:worker/widgets/projects/locations_list.dart';
...
class ProjectListN extends StatefulWidget {
  @override
  _ProjectListNState createState() => _ProjectListNState();
}

class _ProjectListNState extends State<ProjectListN> {
  List listProjects = [];
  String isData = '';
  ...
  Future<dynamic> getProjects() async {
    ...
    var res = await http.get(
        Uri.parse('${ApiWebServer.server_name}/api/v-1/project'),
