...
import 'package:worker/widgets/workday-report/edit_ind/travel.dart';
...
class EditWorkdayInd3 extends StatefulWidget {
  ...
  @override
  _EditWorkdayInd3State createState() =>
      _EditWorkdayInd3State(user, workday, contract, wr, report);
}

class _EditWorkdayInd3State extends State<EditWorkdayInd3> {
  User? user;
  int? workday;
  Map<String, dynamic>? contract;
  WorkdayRegister? wr;
  Map<String, dynamic>? report;
  _EditWorkdayInd3State(
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        _time != 'S/H'
                            ? _time!
                            : widget.wr!.standby_start_time != null
                                ? DateFormat('hh:mm:aa')
                                    .format(widget.wr!.standby_start_time)
                                : 'S/H',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        _time1 != 'S/H'
                            ? _time1!
                            : widget.wr!.standby_end_time != null
                                ? DateFormat('hh:mm:aa')
                                    .format(widget.wr!.standby_end_time)
                                : 'S/H',
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => EditWorkdayInd4(
                                user: user,
                                workday: widget.workday,
                                wr: widget.wr,
                                report: widget.report,
