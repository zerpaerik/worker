...
class OutListCrewReport extends StatefulWidget {
  Map<String, dynamic>? contract;
  Map<String, dynamic>? crew;
  final int? workday;
  Map<String, dynamic>? shift;

  OutListCrewReport({this.contract, this.crew, this.workday, this.shift});

  @override
  _OutListCrewReportState createState() =>
      _OutListCrewReportState(contract, crew, shift);
}

class _OutListCrewReportState extends State<OutListCrewReport> {
  Map<String, dynamic>? contract;
  Map<String, dynamic>? crew;
  Map<String, dynamic>? shift;

  _OutListCrewReportState(this.contract, this.crew, this.shift);
